...
main (int argc, char *argv[])
{
  ...
  // std::string sumo_folder = "src/automotive/examples/sumo_files_v2v_map_lanemerge/";
  // std::string sumo_config = "src/automotive/examples/sumo_files_v2v_map_lanemerge/map.sumo.cfg";
