...
def createRoadGraph(input_file, output_file):
    ...
    graphhml = ET.Element("graphml", attrib={
    ...
    key1 = ET.SubElement(graphhml, "key", attrib={"id": "key1", "for": "edge", "attr.name": "weight", "attr.type": "double"})
    graph_root = ET.SubElement(graphhml, "graph", id="G", edgedefault="directed", parse_nodeids="free", parse_edgeids="canonical", parse_order="nodesfirst") 
