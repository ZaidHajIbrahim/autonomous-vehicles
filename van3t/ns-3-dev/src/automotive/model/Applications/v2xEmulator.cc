...
namespace ns3
{
  ...
  void
  v2xEmulator::SetCollisionAvoider(Ptr<CollisionAvoidance> ca)
  {
    m_collisionAvoider = ca;
  }

  Ptr<CollisionAvoidance>
  v2xEmulator::GetCollisionAvoider() const
  {
    return m_collisionAvoider;
  }
}
