...
namespace ns3
{
  ...
  CABasicService::generateAndEncodeCam()
  {
    ...
    */
    ...
    // Eventuellt lägg till lite saker här Och bygg
    // std::cout << "CAM generationDeltaTime: " << compute_timestampIts (m_real_time) % 65536 << std::endl;
    // std::cout << "CAM generationDeltaTime: " << compute_timestampIts (m_real_time) + TIME_SHIFT << std::endl;
    // std::cout << "CAM generationDeltaTime: " << compute_timestampIts (m_real_time) << std::endl;
